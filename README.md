...
AI-assisted HR recruitment automation platform. Covers the full recruitment lifecycle — job creation, candidate application, resume parsing, AI screening, interview scheduling, feedback, offer letters, e-signature, and onboarding — with a human always in the loop on every hiring decision.
...
**Build status:** all 8 phases complete — see [docs/ROADMAP.md](docs/ROADMAP.md) for what was built in each and how it was verified.
